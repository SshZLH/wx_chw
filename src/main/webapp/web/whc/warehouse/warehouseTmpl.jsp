...
<!-- warehouseList -->
<script type="text/x-tmpl" id="tmpl-warehouseList">
{% 
	var arr = new Array();
			...
			<a class="img"> <img src="<%=supportUrl%>app/whc/uploadFile/import/{%=arr[i].image1%}" /> </a>
				<div class="r">
					...
					<div class="price">
						...
						<div class="gongli">
							<img src="/web/whc/warehouse/img/icon5.png" class="v" />
							<span class="s23">
							{%
								if(arr[i].distance > 1000) {
							%}
							{%=Math.round(arr[i].distance/1000*10)/10%}km
							{%
								} else {
							%}
							{%=arr[i].distance%}m
